module.exports = function (broccoli) {
  ...
  var app = broccoli.makeTree('client/app')
  app = pickFiles(app, {
    srcDir: '/',
  ...
  var styles = broccoli.makeTree('client/styles')
  ...
  var tests = broccoli.makeTree('client/tests')
  ...
  var vendor = broccoli.makeTree('client/vendor')
  ...
  var publicFiles = broccoli.makeTree('client/public')
